  ...
  },
  {
    ...
    submenu: [
      ...
      },
      {
        label: "Redo",
        accelerator:
          process.platform === "darwin" ? "CmdOrCtrl+Y" : "Shift+Command+Z",
        selector: "redo:"
      },
      {
        type: "separator"
      },
      {
        label: "Cut",
        accelerator:
          process.platform === "darwin" ? "CmdOrCtrl+X" : "Command+X",
        selector: "cut:"
      },
      {
        label: "Copy",
        accelerator:
          process.platform === "darwin" ? "CmdOrCtrl+C" : "Command+C",
        selector: "copy:"
      },
      {
        label: "Paste",
        accelerator:
          process.platform === "darwin" ? "CmdOrCtrl+V" : "Command+V",
        selector: "paste:"
      },
      {
        label: "Select All",
        accelerator:
          process.platform === "darwin" ? "CmdOrCtrl+A" : "Command+A",
        selector: "selectAll:"
      }
    ]
  },
